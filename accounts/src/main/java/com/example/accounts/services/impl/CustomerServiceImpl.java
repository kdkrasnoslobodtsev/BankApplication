...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public BigDecimal getBalance(Integer customerId, String currency) throws ConnectException {
        ...
        for (var account : accounts) {
            balance = balance.add(converterClient.convert(account.getCurrency(), currency, account.getAmount(), accessToken));
        }
        return balance;
    }
}
